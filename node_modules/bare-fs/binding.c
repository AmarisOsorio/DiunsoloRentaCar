...
bare_fs_open(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_open(loop, &req->handle, (char *) path, flags, mode, bare_fs__on_open);
...
bare_fs_close(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_close(loop, &req->handle, fd, bare_fs__on_close);
...
bare_fs_access(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_access(loop, &req->handle, (char *) path, mode, bare_fs__on_access);
...
bare_fs_read(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_read(loop, &req->handle, fd, &buf, 1, pos, bare_fs__on_read);
...
bare_fs_readv(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_read(loop, &req->handle, fd, bufs, bufs_len, pos, bare_fs__on_readv);
...
bare_fs_write(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_write(loop, &req->handle, fd, &buf, 1, pos, bare_fs__on_write);
...
bare_fs_writev(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_write(loop, &req->handle, fd, bufs, bufs_len, pos, bare_fs__on_writev);
...
bare_fs_ftruncate(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_ftruncate(loop, &req->handle, fd, len, bare_fs__on_ftruncate);
...
bare_fs_chmod(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_chmod(loop, &req->handle, (char *) path, mode, bare_fs__on_chmod);
...
bare_fs_fchmod(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_fchmod(loop, &req->handle, fd, mode, bare_fs__on_fchmod);
...
bare_fs_utimes(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_utime(loop, &req->handle, (char *) path, atime, mtime, bare_fs__on_utimes);
...
bare_fs_rename(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_rename(loop, &req->handle, (char *) src, (char *) dest, bare_fs__on_rename);
...
bare_fs_copyfile(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_copyfile(loop, &req->handle, (char *) src, (char *) dest, mode, bare_fs__on_copyfile);
...
bare_fs_mkdir(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_mkdir(loop, &req->handle, (char *) path, mode, bare_fs__on_mkdir);
...
bare_fs_rmdir(js_env_t *env, js_callback_info_t *info) {
  ...
  uv_fs_rmdir(loop, &req->handle, (char *) path, bare_fs__on_rmdir);
...
<<<<<<< HEAD
  uv_fs_stat(loop, &req->handle, (char *) path, bare_fs__on_stat);
=======
...
<<<<<<< HEAD
  uv_fs_lstat(loop, &req->handle, (char *) path, bare_fs__on_stat);
=======
...
<<<<<<< HEAD
  uv_fs_fstat(loop, &req->handle, fd, bare_fs__on_stat);
=======
...
<<<<<<< HEAD
  uv_fs_unlink(loop, &req->handle, (char *) path, bare_fs__on_unlink);
=======
...
<<<<<<< HEAD
  uv_fs_realpath(loop, &req->handle, (char *) path, bare_fs__on_realpath);
=======
...
<<<<<<< HEAD
  uv_fs_readlink(loop, &req->handle, (char *) path, bare_fs__on_readlink);
=======
...
<<<<<<< HEAD
  uv_fs_symlink(loop, &req->handle, (char *) target, (char *) path, flags, bare_fs__on_symlink);
=======
...
<<<<<<< HEAD
  uv_fs_opendir(loop, &req->handle, (char *) path, bare_fs__on_opendir);
=======
...
<<<<<<< HEAD
  uv_fs_readdir(loop, &req->handle, dir->dir, bare_fs__on_readdir);
=======
...
<<<<<<< HEAD
  uv_fs_closedir(loop, &req->handle, dir->dir, bare_fs__on_closedir);
=======
