...
=======
    </ul>`}};n([u(v)],f.prototype,"options",void 0),n([u()],f.prototype,"expression",void 0),n([u()],f.prototype,"suggestionFilter",void 0),n([g()],f.prototype,"cursor",void 0),f=n([d("devtools-suggestion-box")],f);let w=class extends h{static shadowRootOptions={...h.shadowRootOptions,delegatesFocus:!0};static styles=[i,s];constructor(){super(),this.options=[],this.expression="",this.placeholder="",this.value="",this.disabled=!1,this.strikethrough=!0,this.mimeType="",this.autocomplete=!0,this.addEventListener("blur",this.#r);let e=o.value().track({keydown:"ArrowUp|ArrowDown|Enter",change:!0,click:!0});this.jslogContext&&(e=e.context(this.jslogContext)),this.setAttribute("jslog",e.toString())}#l;get#a(){if(this.#l)return this.#l;const e=this.renderRoot.querySelector("devtools-editable-content");if(!e)throw new Error("Attempted to query node before rendering.");return this.#l=e,e}#r=()=>{window.getSelection()?.removeAllRanges(),this.value=this.#a.value,this.expression=this.#a.value};#c=e=>{r(e.target instanceof Node);const t=document.createRange();t.selectNodeContents(e.target);const o=window.getSelection();o.removeAllRanges(),o.addRange(t)};#s=e=>{"Enter"===e.key&&e.preventDefault()};#h=e=>{this.expression=e.target.value};#d=e=>{for(const[t,o]of e.listeners)this.addEventListener(t,o)};#u=e=>{this.#a.value=e.suggestion,setTimeout(this.blur.bind(this),0)};willUpdate(e){e.has("value")&&(this.expression=this.value)}render(){return l`<devtools-editable-content
        ?disabled=${this.disabled}
...
=======
      ></devtools-suggestion-box>`}};n([u(v)],w.prototype,"options",void 0),n([u()],w.prototype,"autocomplete",void 0),n([u()],w.prototype,"suggestionFilter",void 0),n([g()],w.prototype,"expression",void 0),n([u()],w.prototype,"placeholder",void 0),n([u()],w.prototype,"value",void 0),n([u({type:Boolean})],w.prototype,"disabled",void 0),n([u()],w.prototype,"strikethrough",void 0),n([u()],w.prototype,"mimeType",void 0),n([u()],w.prototype,"jslogContext",void 0),w=n([d("devtools-suggestion-input")],w);var x=Object.freeze({__proto__:null,get SuggestionInput(){return w}});export{x as SuggestionInput};
>>>>>>> 2c830f7d0232ead70791aff6968a0e95ce850767
