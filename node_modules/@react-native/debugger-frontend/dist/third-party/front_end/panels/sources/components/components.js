...
=======
    ...
    <div class=${m.Directives.classMap(r)}
         ...
         role=treeitem
         tabindex='-1'
         @contextmenu=${t=>{this.#_(t,e,n),t.consume()}}
