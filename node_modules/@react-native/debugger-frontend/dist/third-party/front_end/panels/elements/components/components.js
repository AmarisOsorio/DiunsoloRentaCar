...
<<<<<<< HEAD
      ...
      `}#i(){const e=dt(this.#O,this.#D);r.render(mt`
      <nav class="crumbs" aria-label=${yt(bt.breadcrumbs)} jslog=${l.elementsBreadcrumbs()}>
        ${this.#X("left","start"===this.#_)}

        <div class="crumbs-window" @scroll=${this.#Q}>
          <ul class="crumbs-scroll-container">
            ${e.map((e=>{const t={crumb:!0,selected:e.selected};return mt`
...
>>>>>>> 2c830f7d0232ead70791aff6968a0e95ce850767
                ...
                >
                  <a href="#"
                    ...
                    class="crumb-link"
<<<<<<< HEAD
                    jslog=${l.item().track({click:!0})}
                    @click=${this.#A(e.node)}
                    @mousemove=${this.#q(e.node)}
                    @mouseleave=${this.#F(e.node)}
                    @focus=${this.#V(e.node)}
                    @blur=${this.#U(e.node)}
        ...
        ${this.#X("right","end"===this.#_)}
      </nav>
    `,this.#e,{host:this}),this.#W(),this.#G(),this.#B()}async#B(){if(!this.#D||!this.#e||!this.#P||this.#H)return;const e=this.#D.id,t=this.#e.querySelector(`.crumb[data-node-id="${e}"]`);t&&await o.scroll((()=>{t.scrollIntoView({behavior:"auto"})}))}}customElements.define("devtools-elements-breadcrumbs",xt);var wt=Object.freeze({__proto__:null,ElementsBreadcrumbs:xt,NodeSelectedEvent:ft}),kt={cssText:`:host{display:inline-flex;vertical-align:middle}:host(.hidden){display:none}.expand-button{display:inline-flex;justify-content:center;align-items:center;box-sizing:border-box;width:14px;height:10px;margin:0 2px;border:1px solid var(--override-adorner-border-color,var(--sys-color-tonal-outline));border-radius:10px;background:var(--override-adorner-background-color,var(--sys-color-cdt-base-container));padding:0;position:relative;&:hover::after,\n  &:active::before{content:"";height:100%;width:100%;border-radius:inherit;position:absolute;top:0;left:0}&:hover::after{background-color:var(--sys-color-state-hover-on-subtle)}&:active::before{background-color:var(--sys-color-state-ripple-neutral-on-subtle)}}.expand-button devtools-icon{width:14px;height:14px;color:var(--sys-color-primary)}\n/*# sourceURL=${import.meta.resolve("./elementsTreeExpandButton.css")} */\n`};const St=new CSSStyleSheet;St.replaceSync(kt.cssText);const $t={expand:"Expand"},Ct=e.i18n.registerUIStrings("panels/elements/components/ElementsTreeExpandButton.ts",$t),Nt=e.i18n.getLocalizedString.bind(void 0,Ct);class Et extends HTMLElement{#e=this.attachShadow({mode:"open"});#K=()=>{};set data(e){this.#K=e.clickHandler,this.#J()}#J(){this.#i()}connectedCallback(){this.#e.adoptedStyleSheets=[St]}#i(){i(n`<button
        class="expand-button"
        tabindex="-1"
        aria-label=${Nt($t.expand)}
        jslog=${l.action("expand").track({click:!0})}
        @click=${this.#K}><devtools-icon name="dots-horizontal"></devtools-icon></button>`,this.#e,{host:this})}}customElements.define("devtools-elements-tree-expand-button",Et);var Mt=Object.freeze({__proto__:null,ElementsTreeExpandButton:Et});const jt=e=>({parentNode:e.parentNode?jt(e.parentNode):null,id:e.id,nodeType:e.nodeType(),pseudoType:e.pseudoType(),shadowRootType:e.shadowRootType(),nodeName:e.nodeName(),nodeNameNicelyCased:e.nodeNameInCorrectCase(),legacyDomNode:e,highlightNode:t=>e.highlight(t),clearHighlight:()=>h.OverlayModel.OverlayModel.hideDOMNodeHighlight(),getAttribute:e.getAttribute.bind(e)});var zt=Object.freeze({__proto__:null,legacyNodeToElementsComponentsNode:jt}),Tt={cssText:`*{box-sizing:border-box;font-size:12px}.header{background-color:var(--sys-color-surface2);border-bottom:1px solid var(--sys-color-divider);line-height:1.6;overflow:hidden;padding:0 5px;white-space:nowrap}.header::marker{color:var(--sys-color-on-surface-subtle);font-size:11px;line-height:1}.header:focus{background-color:var(--sys-color-tonal-container)}.content-section{padding:16px;border-bottom:1px solid var(--sys-color-divider);overflow-x:hidden}.content-section-title{font-size:12px;font-weight:500;line-height:1.1;margin:0;padding:0}.checkbox-settings{margin-top:8px;display:grid;grid-template-columns:1fr;gap:5px}.checkbox-label{display:flex;flex-direction:row;align-items:center;min-width:40px;width:fit-content}.checkbox-settings .checkbox-label{margin-bottom:8px}.checkbox-settings .checkbox-label:last-child{margin-bottom:0}.checkbox-label input{margin:0 6px 0 0;padding:0;flex:none}.checkbox-label input:focus{outline:auto 5px -webkit-focus-ring-color}.checkbox-label > span{white-space:nowrap;text-overflow:ellipsis;overflow:hidden}.select-settings{margin-top:16px;width:fit-content}.select-label{display:flex;flex-direction:column}.select-label span{margin-bottom:4px}.elements{margin-top:12px;color:var(--sys-color-token-tag);display:grid;grid-template-columns:repeat(auto-fill,minmax(min(250px,100%),1fr));gap:8px}.element{display:flex;flex-direction:row;align-items:center;gap:8px}.show-element{flex:none}select{min-width:0;max-width:150px}.color-picker{opacity:0%}.color-picker-label{border:1px solid var(--sys-color-neutral-outline);cursor:default;display:inline-block;flex:none;height:10px;width:10px;position:relative;&:focus-within{outline:2px solid var(--sys-color-state-focus-ring);outline-offset:2px;border-radius:2px}}.color-picker-label input[type="color"]{width:100%;height:100%;position:absolute}.color-picker-label:hover,\n.color-picker-label:focus{border:1px solid var(--sys-color-outline);transform:scale(1.2)}.node-text-container{line-height:16px;padding:0 0.5ex;border-radius:5px}\n/*# sourceURL=${import.meta.resolve("./layoutPane.css")} */\n`};const Lt=new CSSStyleSheet;Lt.replaceSync(Be.cssText);const Ot=new CSSStyleSheet;Ot.replaceSync(Tt.cssText);const Dt={chooseElementOverlayColor:"Choose the overlay color for this element",showElementInTheElementsPanel:"Show element in the Elements panel",grid:"Grid",overlayDisplaySettings:"Overlay display settings",gridOverlays:"Grid overlays",noGridLayoutsFoundOnThisPage:"No grid layouts found on this page",flexbox:"Flexbox",flexboxOverlays:"Flexbox overlays",noFlexboxLayoutsFoundOnThisPage:"No flexbox layouts found on this page",colorPickerOpened:"Color picker opened."},Pt=e.i18n.registerUIStrings("panels/elements/components/LayoutPane.ts",Dt),_t=e.i18n.getLocalizedString.bind(void 0,Pt),{render:It,html:Ht}=r,At=e=>{const t=e.getAttribute("class");return{id:e.id,color:"var(--sys-color-inverse-surface)",name:e.localName(),domId:e.getAttribute("id"),domClasses:t?t.split(/\s+/).filter((e=>!!e)):void 0,enabled:!1,reveal:()=>{d.Revealer.reveal(e),e.scrollIntoView()},highlight:()=>{e.highlight()},hideHighlight:()=>{h.OverlayModel.OverlayModel.hideDOMNodeHighlight()},toggle:e=>{throw new Error("Not implemented")},setColor(e){throw new Error("Not implemented")}}},Bt=e=>e.map((e=>{const t=At(e),o=e.id;return{...t,color:e.domModel().overlayModel().colorOfGridInPersistentOverlay(o)||"var(--sys-color-inverse-surface)",enabled:e.domModel().overlayModel().isHighlightedGridInPersistentOverlay(o),toggle:t=>{t?e.domModel().overlayModel().highlightGridInPersistentOverlay(o):e.domModel().overlayModel().hideGridInPersistentOverlay(o)},setColor(t){this.color=t,e.domModel().overlayModel().setColorOfGridInPersistentOverlay(o,t)}}})),Rt=e=>e.map((e=>{const t=At(e),o=e.id;return{...t,color:e.domModel().overlayModel().colorOfFlexInPersistentOverlay(o)||"var(--sys-color-inverse-surface)",enabled:e.domModel().overlayModel().isHighlightedFlexContainerInPersistentOverlay(o),toggle:t=>{t?e.domModel().overlayModel().highlightFlexContainerInPersistentOverlay(o):e.domModel().overlayModel().hideFlexContainerInPersistentOverlay(o)},setColor(t){this.color=t,e.domModel().overlayModel().setColorOfFlexInPersistentOverlay(o,t)}}}));function qt(e){return"enum"===e.type}function Ft(e){return"boolean"===e.type}let Vt;class Ut extends g.LegacyWrapper.WrappableComponent{#e=this.attachShadow({mode:"open"});#Z=[];#ee;#te;constructor(){super(),this.#Z=this.#oe(),this.#ee=d.Settings.Settings.instance().moduleSetting("show-ua-shadow-dom"),this.#te=[],this.#e.adoptedStyleSheets=[p.checkboxStyles,Ot,Lt]}static instance(){return Vt||(Vt=g.LegacyWrapper.legacyWrapper(c.Widget.Widget,new Ut)),Vt.element.style.minWidth="min-content",Vt.element.setAttribute("jslog",`${l.pane("layout").track({resize:!0})}`),Vt.getComponent()}modelAdded(e){const t=e.overlayModel();t.addEventListener("PersistentGridOverlayStateChanged",this.render,this),t.addEventListener("PersistentFlexContainerOverlayStateChanged",this.render,this),this.#te.push(e)}modelRemoved(e){const t=e.overlayModel();t.removeEventListener("PersistentGridOverlayStateChanged",this.render,this),t.removeEventListener("PersistentFlexContainerOverlayStateChanged",this.render,this),this.#te=this.#te.filter((t=>t!==e))}async#re(e){const t=this.#ee.get(),o=[];for(const r of this.#te)try{const n=await r.getNodesByStyle(e,!0);for(const e of n){const n=r.nodeForId(e);null===n||!t&&n.ancestorUserAgentShadowRoot()||o.push(n)}}catch(e){console.warn(e)}return o}async#ne(){return await this.#re([{name:"display",value:"grid"},{name:"display",value:"inline-grid"}])}async#se(){return await this.#re([{name:"display",value:"flex"},{name:"display",value:"inline-flex"}])}#oe(){const e=[];for(const t of["show-grid-line-labels","show-grid-track-sizes","show-grid-areas","extend-grid-lines"]){const o=d.Settings.Settings.instance().moduleSetting(t),r=o.get(),n=o.type();if(!n)throw new Error("A setting provided to LayoutSidebarPane does not have a setting type");if("boolean"!==n&&"enum"!==n)throw new Error("A setting provided to LayoutSidebarPane does not have a supported setting type");const s={type:n,name:o.name,title:o.title()};("boolean"==typeof r||"string"==typeof r)&&e.push({...s,value:r,options:o.options().map((e=>({...e,value:e.value})))})}return e}onSettingChanged(e,t){d.Settings.Settings.instance().moduleSetting(e).set(t)}wasShown(){for(const e of this.#Z)d.Settings.Settings.instance().moduleSetting(e.name).addChangeListener(this.render,this);for(const e of this.#te)this.modelRemoved(e);this.#te=[],h.TargetManager.TargetManager.instance().observeModels(h.DOMModel.DOMModel,this,{scoped:!0}),c.Context.Context.instance().addFlavorChangeListener(h.DOMModel.DOMNode,this.render,this),this.#ee.addChangeListener(this.render,this),this.render()}willHide(){for(const e of this.#Z)d.Settings.Settings.instance().moduleSetting(e.name).removeChangeListener(this.render,this);h.TargetManager.TargetManager.instance().unobserveModels(h.DOMModel.DOMModel,this),c.Context.Context.instance().removeFlavorChangeListener(h.DOMModel.DOMNode,this.render,this),this.#ee.removeChangeListener(this.render,this)}#ie(e){if(!e.target)return;const t=e.target.parentElement;if(!t)throw new Error("<details> element is not found for a <summary> element");switch(e.key){case"ArrowLeft":t.open=!1;break;case"ArrowRight":t.open=!0}}async render(){const e=Bt(await this.#ne()),t=Rt(await this.#se());await o.write("LayoutPane render",(()=>{It(Ht`
        <details open>
          <summary class="header" @keydown=${this.#ie} jslog=${l.sectionHeader("grid-settings").track({click:!0})}>
            ${_t(Dt.grid)}
          </summary>
          <div class="content-section" jslog=${l.section("grid-settings")}>
            <h3 class="content-section-title">${_t(Dt.overlayDisplaySettings)}</h3>
            <div class="select-settings">
              ${this.#ae().map((e=>this.#le(e)))}
            </div>
            <div class="checkbox-settings">
              ${this.#ce().map((e=>this.#de(e)))}
            </div>
          </div>
          ${e?Ht`<div class="content-section" jslog=${l.section("grid-overlays")}>
              <h3 class="content-section-title">
                ${e.length?_t(Dt.gridOverlays):_t(Dt.noGridLayoutsFoundOnThisPage)}
              </h3>
              ${e.length?Ht`<div class="elements">
                  ${e.map((e=>this.#pe(e)))}
                </div>`:""}
            </div>`:""}
        </details>
        ${void 0!==t?Ht`
          <details open>
            <summary class="header" @keydown=${this.#ie} jslog=${l.sectionHeader("flexbox-overlays").track({click:!0})}>
              ${_t(Dt.flexbox)}
            </summary>
            ${t?Ht`<div class="content-section" jslog=${l.section("flexbox-overlays")}>
                <h3 class="content-section-title">
                  ${t.length?_t(Dt.flexboxOverlays):_t(Dt.noFlexboxLayoutsFoundOnThisPage)}
                </h3>
                ${t.length?Ht`<div class="elements">
                    ${t.map((e=>this.#pe(e)))}
=======
...
>>>>>>> 2c830f7d0232ead70791aff6968a0e95ce850767
          ...
          `:""}
<<<<<<< HEAD
      `,this.#e,{host:this})}))}#ae(){return this.#Z.filter(qt)}#ce(){return this.#Z.filter(Ft)}#ue(e,t){t.preventDefault(),this.onSettingChanged(e.name,t.target.checked)}#he(e,t){t.preventDefault(),this.onSettingChanged(e.name,t.target.value)}#ge(e,t){t.preventDefault(),e.toggle(t.target.checked)}#me(e,t){t.preventDefault(),e.reveal()}#be(e,t){t.preventDefault(),e.setColor(t.target.value),this.render()}#ve(e,t){t.preventDefault(),e.highlight()}#ye(e,t){t.preventDefault(),e.hideHighlight()}#pe(e){const t=this.#ge.bind(this,e),o=this.#me.bind(this,e),r=this.#be.bind(this,e),n=this.#ve.bind(this,e),s=this.#ye.bind(this,e);return Ht`<div class="element" jslog=${l.item()}>
      <label data-element="true" class="checkbox-label">
        <input data-input="true" type="checkbox" .checked=${e.enabled} @change=${t} jslog=${l.toggle().track({click:!0})} />
        <span class="node-text-container" data-label="true" @mouseenter=${n} @mouseleave=${s}>
          <devtools-node-text .data=${{nodeId:e.domId,nodeTitle:e.name,nodeClasses:e.domClasses}}></devtools-node-text>
        </span>
      </label>
      <label @keyup=${e=>{if("Enter"!==e.key&&" "!==e.key)return;e.target.querySelector("input").click(),c.ARIAUtils.alert(_t(Dt.colorPickerOpened)),e.preventDefault()}} @keydown=${e=>{" "===e.key&&e.preventDefault()}} class="color-picker-label" style="background: ${e.color};" jslog=${l.showStyleEditor("color").track({click:!0})}>
        <input @change=${r} @input=${r} title=${_t(Dt.chooseElementOverlayColor)} tabindex="0" class="color-picker" type="color" value=${e.color} />
      </label>
      <devtools-button class="show-element"
                                           .title=${_t(Dt.showElementInTheElementsPanel)}
                                           aria-label=${_t(Dt.showElementInTheElementsPanel)}
=======
...
<<<<<<< HEAD
    ...
    </div>`}#de(e){const t=this.#ue.bind(this,e);return Ht`<label data-boolean-setting="true" class="checkbox-label" title=${e.title} jslog=${l.toggle().track({click:!0}).context(e.name)}>
      <input data-input="true" type="checkbox" .checked=${e.value} @change=${t} />
      <span data-label="true">${e.title}</span>
    </label>`}#le(e){const o=this.#he.bind(this,e);return Ht`<label data-enum-setting="true" class="select-label" title=${e.title}>
      <select
        data-input="true"
        jslog=${l.dropDown().track({change:!0}).context(e.name)}
        @change=${o}>
        ${e.options.map((o=>Ht`<option value=${o.value} .selected=${e.value===o.value} jslog=${l.item(t.StringUtilities.toKebabCase(o.value)).track({click:!0})}>${o.title}</option>`))}
      </select>
    </label>`}}customElements.define("devtools-layout-pane",Ut);var Gt=Object.freeze({__proto__:null,LayoutPane:Ut}),Wt=Object.freeze({__proto__:null}),Qt={cssText:`.container-link{display:inline-block;color:var(--sys-color-state-disabled)}.container-link:hover{color:var(--sys-color-primary)}.queried-size-details{color:var(--sys-color-on-surface)}.axis-icon{margin-left:0.4em;width:16px;height:12px;vertical-align:text-top}.axis-icon.hidden{display:none}.axis-icon.vertical{transform:rotate(90deg)}\n/*# sourceURL=${import.meta.resolve("./queryContainer.css")} */\n`};const Yt=new CSSStyleSheet;Yt.replaceSync(Qt.cssText);const{render:Xt,html:Kt}=r,{PhysicalAxis:Jt,QueryAxis:Zt}=h.CSSContainerQuery;class eo extends Event{static eventName="queriedsizerequested";constructor(){super(eo.eventName,{})}}class to extends HTMLElement{#e=this.attachShadow({mode:"open"});#C;#fe;#xe;#we=!1;#ke;set data(e){this.#C=e.queryName,this.#fe=e.container,this.#xe=e.onContainerLinkClick,this.#i()}connectedCallback(){this.#e.adoptedStyleSheets=[Yt]}updateContainerQueriedSizeDetails(e){this.#ke=e,this.#i()}async#Se(){this.#fe?.highlightNode("container-outline"),this.#we=!0,this.dispatchEvent(new eo)}#$e(){this.#fe?.clearHighlight(),this.#we=!1,this.#i()}#i(){if(!this.#fe)return;let e,t;this.#C||(e=this.#fe.getAttribute("id"),t=this.#fe.getAttribute("class")?.split(/\s+/).filter(Boolean));const o=this.#C||this.#fe.nodeNameNicelyCased;Xt(Kt`
=======
...
<<<<<<< HEAD
        jslog=${l.cssRuleHeader("container-query").track({click:!0})}
        @click=${this.#xe}
        @mouseenter=${this.#Se}
        @mouseleave=${this.#$e}
      ><devtools-node-text
      ...
      ${this.#we?this.#Ce():r.nothing}
    `,this.#e,{host:this})}#Ce(){if(!this.#ke||""===this.#ke.queryAxis)return r.nothing;const e="size"===this.#ke.queryAxis,t=r.Directives.classMap({"axis-icon":!0,hidden:e,vertical:"Vertical"===this.#ke.physicalAxis});return Kt`
      <span class="queried-size-details">
        (${this.#ke.queryAxis}<devtools-icon
          class=${t} .data=${{iconName:"width",color:"var(--icon-default)"}}></devtools-icon>)
        ${e&&this.#ke.width?"width:":r.nothing}
        ${this.#ke.width||r.nothing}
        ${e&&this.#ke.height?"height:":r.nothing}
        ${this.#ke.height||r.nothing}
      </span>
    `}}customElements.define("devtools-query-container",to);var oo=Object.freeze({__proto__:null,QueriedSizeRequestedEvent:eo,QueryContainer:to}),ro={cssText:`.container{min-width:170px}.row{padding:0;color:var(--sys-color-on-surface);padding-bottom:16px}.row:last-child{padding-bottom:0}.property{padding-bottom:4px;white-space:nowrap}.property-name{color:var(--sys-color-token-property-special)}.property-value{color:var(--sys-color-on-surface)}.property-value.not-authored{color:var(--sys-color-state-disabled)}.buttons{display:flex;flex-direction:row}.buttons > :first-child{border-radius:3px 0 0 3px}.buttons > :last-child{border-radius:0 3px 3px 0}.button{border:1px solid var(--sys-color-neutral-outline);background-color:var(--sys-color-cdt-base-container);width:24px;height:24px;min-width:24px;min-height:24px;padding:0;margin:0;display:flex;justify-content:center;align-items:center;cursor:pointer}.button:focus-visible{outline:auto 5px -webkit-focus-ring-color}.button devtools-icon{color:var(--icon-default)}.button:hover devtools-icon{color:var(--icon-default-hover)}.button.selected devtools-icon{color:var(--icon-toggled)}\n/*# sourceURL=${import.meta.resolve("./stylePropertyEditor.css")} */\n`};const no=new CSSStyleSheet;no.replaceSync(ro.cssText);const so={selectButton:"Add {propertyName}: {propertyValue}",deselectButton:"Remove {propertyName}: {propertyValue}"},io=e.i18n.registerUIStrings("panels/elements/components/StylePropertyEditor.ts",so),ao=e.i18n.getLocalizedString.bind(void 0,io),{render:lo,html:co,Directives:po}=r;class uo extends Event{static eventName="propertyselected";data;constructor(e,t){super(uo.eventName,{}),this.data={name:e,value:t}}}class ho extends Event{static eventName="propertydeselected";data;constructor(e,t){super(ho.eventName,{}),this.data={name:e,value:t}}}class go extends HTMLElement{#e=this.attachShadow({mode:"open"});#Ne=new Map;#Ee=new Map;editableProperties=[];constructor(){super()}connectedCallback(){this.#e.adoptedStyleSheets=[no]}getEditableProperties(){return this.editableProperties}set data(e){this.#Ne=e.authoredProperties,this.#Ee=e.computedProperties,this.#i()}#i(){lo(co`
      <div class="container">
        ${this.editableProperties.map((e=>this.#Me(e)))}
      </div>
    `,this.#e,{host:this})}#Me(e){const t=this.#Ne.get(e.propertyName),o=!t,r=t||this.#Ee.get(e.propertyName),n=po.classMap({"property-value":!0,"not-authored":o});return co`<div class="row">
      <div class="property">
        <span class="property-name">${e.propertyName}</span>: <span class=${n}>${r}</span>
      </div>
      <div class="buttons">
        ${e.propertyValues.map((o=>this.#je(o,e.propertyName,o===t)))}
      </div>
    </div>`}#je(e,t,o=!1){const r=`${t}: ${e}`,n=this.findIcon(r,this.#Ee);if(!n)throw new Error(`Icon for ${r} is not found`);const s=`transform: rotate(${n.rotate}deg) scale(${n.scaleX}, ${n.scaleY})`,i=po.classMap({button:!0,selected:o}),a={propertyName:t,propertyValue:e},c=ao(o?so.deselectButton:so.selectButton,a);return co`
      <button title=${c}
              class=${i}
              jslog=${l.item().track({click:!0}).context(`${t}-${e}`)}
              @click=${()=>this.#ze(t,e,o)}>
        <devtools-icon style=${s} name=${n.iconName}>
        </devtools-icon>
      </button>
    `}#ze(e,t,o){o?this.dispatchEvent(new ho(e,t)):this.dispatchEvent(new uo(e,t))}findIcon(e,t){throw new Error("Not implemented")}}class mo extends go{jslogContext="cssFlexboxEditor";editableProperties=vo;findIcon(e,t){return Pe(e,t)}}customElements.define("devtools-flexbox-editor",mo);class bo extends go{jslogContext="cssGridEditor";editableProperties=yo;findIcon(e,t){return Ie(e,t)}}customElements.define("devtools-grid-editor",bo);const vo=[{propertyName:"flex-direction",propertyValues:["row","column","row-reverse","column-reverse"]},{propertyName:"flex-wrap",propertyValues:["nowrap","wrap"]},{propertyName:"align-content",propertyValues:["center","flex-start","flex-end","space-around","space-between","stretch"]},{propertyName:"justify-content",propertyValues:["center","flex-start","flex-end","space-between","space-around","space-evenly"]},{propertyName:"align-items",propertyValues:["center","flex-start","flex-end","stretch","baseline"]}],yo=[{propertyName:"align-content",propertyValues:["center","space-between","space-around","space-evenly","stretch"]},{propertyName:"justify-content",propertyValues:["center","start","end","space-between","space-around","space-evenly"]},{propertyName:"align-items",propertyValues:["center","start","end","stretch","baseline"]},{propertyName:"justify-items",propertyValues:["center","start","end","stretch"]}];var fo=Object.freeze({__proto__:null,FlexboxEditableProperties:vo,FlexboxEditor:mo,GridEditableProperties:yo,GridEditor:bo,PropertyDeselectedEvent:ho,PropertySelectedEvent:uo,StylePropertyEditor:go});export{k as AccessibilityTreeNode,M as AdornerManager,I as AnchorFunctionLinkSwatch,Z as CSSHintDetailsView,ie as CSSPropertyDocsView,Ae as CSSPropertyIconResolver,We as CSSQuery,st as CSSVariableValueView,q as ComputedStyleProperty,G as ComputedStyleTrace,wt as ElementsBreadcrumbs,ht as ElementsBreadcrumbsUtils,Mt as ElementsTreeExpandButton,zt as Helper,Gt as LayoutPane,Wt as LayoutPaneUtils,oo as QueryContainer,fo as StylePropertyEditor};
=======
