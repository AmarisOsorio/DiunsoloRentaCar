...
const MaintenanceTypeDetail = ({ maintenanceType, isEditing, onTypeChange }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity 
        style={[styles.typeContainer, isEditing && styles.editableContainer]}
        onPress={() => isEditing && setShowTypeModal(true)}
        disabled={!isEditing}
      >
        <Text style={styles.typeText}>{maintenanceType}</Text>
        {isEditing && (
