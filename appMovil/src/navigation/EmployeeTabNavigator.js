...
import HomeEmployees from '../screens/HomeEmployees/HomeEmployees';
...
const TabArr = [
  { route: 'HomeEmployees', label: 'Inicio', icon: 'home', component: HomeEmployees },
  ...
  { route: 'Maintenance', label: 'Mantto.', icon: 'build', component: Maintenance, title: 'Mantenimientos' },
  { route: 'Clients', label: 'Usuarios', icon: 'people', component: Clients },
]; 
