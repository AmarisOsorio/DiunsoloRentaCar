...
import HomeManager from '../screens/HomeManager/HomeManager';
...
const TabArr = [
  { route: 'HomeManager', label: 'Inicio', icon: 'home', component: HomeManager },
...
// Componente principal del Tab Navigator para el gerente
